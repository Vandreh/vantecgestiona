CREATE TABLE public.tb_profiles1 (
    id_profile integer,
...
CREATE TABLE  public.detalle_ventas (
  ...
  user_created_in timestamp NULL DEFAULT current_timestamp  user_cpf varchar(30) NOT NULL
);
