<h3>
	<i class="fa fa-plus"></i>
	  4 MESES PARA EL VENCIMIENTO DE LOS PRODUCTOS: 
</h3>
...
<?php  
    ...
    # Busca	
	$table_content = selectproducto4("estoque",null,$cpf1,null);
	...
	$table_color = "#FF69B4";
	$table_icon = "plus";
	$table_header = " 4 MESES PARA EL VENCIMIENTO DE LOS PRODUCTOS: <hr>";
