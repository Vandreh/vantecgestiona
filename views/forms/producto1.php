<h3>
	<i class="fa fa-plus"></i>
	  1 MES PARA EL VENCIMIENTO DE LOS PRODUCTOS: 
</h3>
...
<?php  
    ...
    # Busca	
	$table_content = selectproducto1("estoque",null,$cpf1,null);
	...
	$table_color = "#FF69B4";
	$table_icon = "plus";
	$table_header = " 1 MES PARA EL VENCIMIENTO DE LOS PRODUCTOS: <hr>";
