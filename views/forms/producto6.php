<h3>
	<i class="fa fa-plus"></i>
	  6 MESES PARA EL VENCIMIENTO DE LOS PRODUCTOS: 
</h3>
...
<?php  
    ...
    # Busca	
	$table_content = selectproducto6("estoque",null,$cpf1,null);
	...
	$table_color = "#FF69B4";
	$table_icon = "plus";
	$table_header = " 6 MESES PARA EL VENCIMIENTO DE LOS PRODUCTOS: <hr>";
